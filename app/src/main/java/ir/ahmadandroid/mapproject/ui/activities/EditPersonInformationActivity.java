...
//            editInfo();
    ...
    private void editInfoByDatabase() {
        int editResult = myDatabase.editTestInDb(getPerson());
        if (editResult==1){
            Toast.makeText(this, R.string.message_edit_person_info, Toast.LENGTH_LONG).show();
        }else {
            Toast.makeText(this, R.string.message_not_edit_person_info, Toast.LENGTH_LONG).show();
        }
    ...
    private void editInfo(){
        ...
        Call<MessageToken> call = retrofitService.editPersonInfo(personNationalCodeApiKey);
